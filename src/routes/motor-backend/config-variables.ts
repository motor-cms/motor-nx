...
const routes: Array<RouteRecordRaw> = [
   ...
   */
  {
    ...
    meta: {
      ...
      title:
        'motor-backend.config_variables.config_variables',
    },
    beforeEnter: checkAuth,
    component: () =>
      import(
        '@/views/admin/motor-backend/config-variables/index.vue'
      ),
  },
  {
    ...
    component: () =>
      import(
        '@/views/admin/motor-backend/config-variables/edit.vue'
      ),
  },
  {
